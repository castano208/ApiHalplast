...
const enviosPost = async (req, res) => {
    const { estadoEnvio, totalEnvio, direccionEnvio, detalleVenta } = req.body;
    const nuevoEnvio = new Envio({ estadoEnvio, totalEnvio, direccionEnvio, detalleVenta });
    try {
